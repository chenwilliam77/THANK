...
steady_state = h5read("eqcond.h5", "steadystate")

@testset "Steady state" begin
    @test @test_matrix_approx_eq vec(steady_state) vec( map(x -> x.value, m.steady_state))
end

@testset "THANK equilibrium conditions" begin
...
@testset "THANK reduced form transition matrices" begin
