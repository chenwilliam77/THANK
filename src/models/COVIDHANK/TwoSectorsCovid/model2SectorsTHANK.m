...
k           = 3;     % capital
kbarS       = 4;     % physical capital (S-type HHs)
L1          = 5;     % hours (sector 1)
L2          = 6;     % hours (sector 2)
klr1        = 7;     % capital-labor ratio (sector 1)
klr2        = 8;     % capital-labor ratio (sector 2)
w1          = 9;     % real wage (sector 1)
w2          = 10;    % real wage (sector 2)
p           = 11;    % inflation
p1          = 12;    % inflation (sector 1)
p2          = 13;    % inflation (sector 2)
mc1         = 14;    % marginal cost (sector 1)
mc2         = 15;    % marginal cost (sector 2)
lambdap     = 16;    % price markup shock
lambdaw     = 17;    % wage markup shock
lambdaS     = 18;   % mu of consumption (S-type HHs)
lambdaH1    = 19;   % mu of consumption (H1-type HHs)
lambdaH2    = 20;   % mu of consumption (H2-type HHs)
lambdaSH1   = 21;   % average mu of consumption (S and H2-type HHs)
lambdaSH2   = 22;   % average mu of consumption (S and H2-type HHs)
c           = 23;   % consumption
cH1         = 24;   % consumption (H1-type HHs)
cH2         = 25;   % consumption (H2-type HHs)
cS          = 26;   % consumption (S-type HHs)
iS          = 27;   % investment (S-type HHs)
R           = 28;   % nominal interest rate
u           = 29;   % capital utilization
phi         = 30;   % "capital" multiplier
z           = 31;  % productivity shock
Rk          = 32;    % return on capital (rho)
a           = 33;  % relative technology
d           = 34;  % demand for sectoral goods
x           = 35;   % real GDP
b           = 36;  % intertemporal preference shock
t           = 37;   % taxes
g           = 38; % government spending shock
gw1         = 39;   % wage gap (sector 1)
gw2         = 40;   % wage gap (sector 1)
miu         = 41;  % investment shock
bR          = 42;   % real government debt
mp          = 43; % monetary policy shock
tS          = 44;   % taxes (S-type HHs)
tH1         = 45;   % taxes (H1-type HHs)
tH3         = 46;   % taxes (H2-type HHs)
tau         = 47;   % transfers
tauS        = 48; % transfer shock (S-type HHs)
tauH1       = 49;  % transfer shock (H1-type HHs)
tauH2       = 50;  % transfer shock (H2-type HHs)
